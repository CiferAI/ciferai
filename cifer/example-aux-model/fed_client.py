...
class FedClient(fed_grpc_pb2_grpc.FederatedServiceServicer):
    ...
    def runClient(self):
        ...
        # Convert cid to string before sending
        register_out = client.clientRegister(fed_grpc_pb2.registerArgs(ip=self.client_ip, port=port, cid=str(self.cid)))
...
if __name__ == '__main__':
    ...
    try:
        cid = int(sys.argv[1])  # Convert cid to integer
    except IndexError:
